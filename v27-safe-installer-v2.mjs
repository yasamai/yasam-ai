...
try {
  ...
  try {
    fs.writeFileSync(abs("v27-typecheck-error.txt"), details, "utf8");
  } catch {}
  restoreAll();
  console.error("\nTypecheck hatası:\n", details);
  die("v27 typecheck başarısız oldu. Script tüm v27 değişikliklerini otomatik geri aldı. Ayrıntı: v27-typecheck-error.txt");
}
