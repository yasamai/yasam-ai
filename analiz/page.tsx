/*
YAŞAM AI - PREMIUM PLATFORM VE AI STRATEJİ ODASI 16.0
...
import { PremiumScoreGrid } from "./components";
type FormState = {
  city: string;
  district: string;
  neighborhood: string;
    ...
    >
      ...
      >
        <div>
          ...
          >
            YAŞAM AI ÇEVRE VE ULAŞIM ZEKÂSI 7.0
          </div>
          <h2
    ...
    >
      <div style={{ width: "100%", maxWidth: "1220px", margin: "0 auto" }}>
        <AnalysisHeader
          ...
          dataTrustScore={result ? scores[0].value : 88}
          aiStatus={loading ? "processing" : result ? "ready" : "limited"}
        />

        <PremiumScoreGrid
          title={result ? "AI Karar Puanları" : "Premium Analiz Önizlemesi"}
          subtitle={
            result
              ? "Puanlar, yapay zekâ raporundaki bulgulara göre otomatik güncellenmiştir."
              : "Analiz tamamlandığında puanlar gerçek rapor sonuçlarına göre otomatik güncellenecektir."
          }
          scores={(result
            ? scores
            : [
                {
                  title: "Veri Güveni",
                  value: 88,
                  description: "Analiz öncesi örnek güven görünümü.",
                },
                {
                  title: "Yatırım",
                  value: 91,
                  description: "Analiz öncesi örnek yatırım görünümü.",
                },
                {
                  title: "Risk",
                  value: 24,
                  description: "Düşük değer daha olumlu kabul edilir.",
                  inverse: true,
                },
                {
                  title: "Likidite",
                  value: 83,
                  description: "Analiz öncesi örnek likidite görünümü.",
                },
              ]
          ).map((score) => ({
            title: score.title.replace(" Skoru", "").replace(" Puanı", ""),
            value: score.value,
        ...
        <header style={{ textAlign: "center", marginBottom: "30px" }}>
          ...
          >
            ✦ YAŞAM AI • PREMIUM KARAR MERKEZİ 16.0
          </div>
...
<div style={{color:"#1d4ed8",fontWeight:900,fontSize:"12px"}}>AI EMSAL VE DEĞERLEME MOTORU 8.0</div>
<h2 style={{margin:"8px 0 18px",color:"#0f2742"}}>Profesyonel Değer Analizi</h2>

<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:"14px"}}>
<MetricCard label="TAHMİNİ PİYASA DEĞERİ" value="4.180.000 TL" note="AI hesaplaması (demo)." />
<MetricCard label="İDEAL İLAN FİYATI" value="4.290.000 TL" note="Rekabetçi satış önerisi." />
<MetricCard label="HIZLI SATIŞ FİYATI" value="4.050.000 TL" note="Likidite odaklı öneri." />
<MetricCard label="FİYAT DURUMU" value="Normal" note="Piyasa ile uyumlu." />
<MetricCard label="PAZARLIK PAYI" value="%4 - %6" note="AI önerisi." />
<MetricCard label="DEĞER GÜVENİ" value="88 / 100" note="Gerçek veri entegrasyonunda dinamik." />
</div>
...
Bu taşınmazın fiyatı mevcut analiz kriterlerine göre piyasa aralığıyla uyumlu görünüyor.
İlan fiyatı korunabilir; hızlı satış hedeflenirse sınırlı bir indirim düşünülebilir.
Gerçek emsal satış verileri bağlandığında değerlendirme tamamen otomatik güncellenecektir.
</p>
</div>
</section>
  ...
  <div style={{
    ...
    <div style={{
      ...
      <div style={{ display: "grid", gap: "10px" }}>
        {[
          ["Temkinli Senaryo", "1.280.000 TL", "%18,7", "Satış süresi uzar, fiyat baskısı oluşur."],
          ["Beklenen Senaryo", "2.070.000 TL", "%30,2", "Mevcut piyasa varsayımlarına göre."],
          ["Güçlü Piyasa Senaryosu", "2.740.000 TL", "%40,0", "Talep ve satış fiyatı yükselirse."]
    ...
    <div style={{
      ...
      {[
        ["Taşınmaz Alım Bedeli", "4.250.000 TL", 62],
        ["İnşaat / Geliştirme", "1.850.000 TL", 27],
        ["Ruhsat ve Resmî Giderler", "320.000 TL", 5],
        ["Finansman ve Diğer Giderler", "430.000 TL", 6]
  ...
  <div style={{
    ...
    <div style={{
      ...
      <p style={{ marginBottom: 0, lineHeight: 1.8, color: "#52657b" }}>
        Beklenen senaryoda yatırım, maliyetine göre güçlü bir kâr marjı üretmektedir.
        Satın alma fiyatı korunur ve geliştirme maliyetleri kontrol altında tutulursa
        proje finansal açıdan uygulanabilir görünmektedir. Nihai karar öncesinde resmî
        imar verisi, kesin metraj, gerçek teklif ve satış emsalleri doğrulanmalıdır.
      </p>
    </div>
  </div>
</section>
...
<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:"14px"}}>
<MetricCard label="ÖNERİLEN İLK TEKLİF" value="4.020.000 TL" note="AI başlangıç önerisi"/>
<MetricCard label="HEDEF ANLAŞMA" value="4.110.000 TL" note="En dengeli sonuç"/>
<MetricCard label="MAKSİMUM FİYAT" value="4.240.000 TL" note="Bunun üzeri önerilmez"/>
<MetricCard label="ANLAŞMA OLASILIĞI" value="%81" note="Mevcut varsayımlara göre"/>
<MetricCard label="PAZARLIK GÜCÜ" value="Yüksek" note="Emsal analizine göre"/>
<MetricCard label="AI KARARI" value="Pazarlığa Başla" note="Premium öneri"/>
</div>
...
<p style={{lineHeight:1.8,color:"#52657b"}}>
Merhaba. Taşınmazınızı detaylı olarak inceledim. Bölgedeki emsal satışlar ve mevcut piyasa koşulları doğrultusunda ciddi alıcı olarak 4.020.000 TL teklif etmek istiyorum. Uygun görmeniz halinde süreci hızlı şekilde tamamlayabiliriz.
</p>
</div>
...
<MetricCard label="RAPOR SKORU" value="94 / 100" note="Genel değerlendirme"/>
<MetricCard label="YATIRIM KARARI" value="Olumlu" note="AI önerisi"/>
...
<section style={{
  ...
  <div style={{
    ...
    PAKET 12 · KULLANICI HESABI VE RAPOR GEÇMİŞİ
  </div>

  <h2 style={{margin:"8px 0 6px",color:"#0f2742"}}>
    Kullanıcı Paneli ve Rapor Arşivi
  </h2>

  <p style={{margin:"0 0 18px",color:"#64748b",lineHeight:1.7}}>
    Kullanıcıların analizlerini kaydetmesi, geçmiş raporlarına yeniden ulaşması
    ve favori taşınmazlarını tek panelden yönetmesi için hazırlanmıştır.
  </p>
  ...
  <div style={{
    ...
    <MetricCard label="TOPLAM RAPOR" value="12" note="Kayıtlı analizler"/>
    <MetricCard label="FAVORİLER" value="4" note="Kaydedilen taşınmazlar"/>
    <MetricCard label="PREMIUM DURUMU" value="Aktif" note="Kurumsal plan"/>
    <MetricCard label="SON ANALİZ" value="Bugün" note="En son rapor tarihi"/>
  </div>
  ...
  <div style={{
    ...
    <div style={{
      ...
      <h3 style={{marginTop:0,color:"#0f4c81"}}>Son Raporlar</h3>

      {[
        ["Ceyhan · Namık Kemal Mahallesi", "Arsa Analizi", "94 / 100"],
        ["Ceyhan · Cumhuriyet Mahallesi", "Konut Analizi", "88 / 100"],
        ["Ceyhan · Ulus Mahallesi", "İşyeri Analizi", "82 / 100"]
      ].map(([title, type, score]) => (
        <div key={title} style={{
          padding:"13px 0",
  ...
  <div style={{
    ...
    <h3 style={{marginTop:0}}>Premium Hesap Avantajları</h3>
    <ul style={{margin:0,paddingLeft:"20px",lineHeight:1.9}}>
      <li>Sınırsız rapor arşivi</li>
      <li>Favori taşınmaz takibi</li>
      <li>PDF ve yazdırma geçmişi</li>
      <li>AI pazarlık asistanına hızlı erişim</li>
      <li>Gelecekte fiyat değişimi bildirimleri</li>
    </ul>
  </div>
  ...
  <div style={{
    ...
    <strong style={{color:"#0f2742"}}>Altyapı Notu</strong>
    <p style={{marginBottom:0,lineHeight:1.8,color:"#52657b"}}>
      Bu paket kullanıcı panelinin profesyonel arayüzünü hazırlar.
      Gerçek kullanıcı girişi, veritabanına rapor kaydı, favoriler ve üyelik yönetimi
      sonraki entegrasyon aşamasında Supabase veya benzeri güvenli bir altyapıyla bağlanacaktır.
    </p>
  </div>
</section>
...
PAKET 15 · GOLD ÜYELİK VE AI STRATEJİ ODASI
</div>
